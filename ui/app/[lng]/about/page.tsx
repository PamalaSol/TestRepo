...
export default function About({ params: { lng } }: { params: { lng: string } }) {
	...
	return (
		<div className="scroll mt-6 grid grid-cols-11 max-laptop:mt-16 laptop:h-[95vh] laptop:overflow-clip">
			<div className="col-span-11 border-r-[#C8C8C8] lg:col-span-6 laptop:border-r">
				<div className="flex h-full flex-col items-end justify-end lg:grid lg:grid-cols-11">
					...
					<div className="col-span-1 flex h-full w-[36%] items-center justify-center justify-self-end max-laptop:hidden">
						<div className="col-span-1 flex h-5 rotate-0 max-tablet:mb-6 max-tablet:flex-wrap max-tablet:gap-3 max-tablet:px-4 tablet:gap-10 lg:-rotate-90">
							<button
								onClick={() => {
					...
					<div className="flex-grid flex w-full justify-between gap-3 px-4 laptop:hidden">
						<button
							onClick={() => {
								if (yearSelected === '2024') {
									setYearSelected('');
			...
			<div className="col-span-11 py-3 max-laptop:px-4 max-laptop:pb-10 lg:col-span-5 laptop:grid laptop:h-[90vh] laptop:grid-rows-5">
				...
				<div className="row-span-3 flex h-full w-full justify-center max-laptop:mt-10 laptop:relative">
					<div className={`grid grid-cols-12 laptop:absolute laptop:top-7`}>
						<div className="col-span-2 grid-cols-2 max-laptop:hidden"></div>
						<div className="col-span-4 grid-cols-4 space-y-5 max-laptop:col-span-6">
