							...
							<div className="mt-16 grid grid-cols-11 border-x border-x-[#C8C8C8]">
								...
								<div className="col-span-11 -mt-10 flex h-[85vh] flex-col items-start justify-between px-6 lg:col-span-5 ">
									...
									<div className="grid grid-rows-4 max-laptop:pt-4 ">
										{links.map((link, idx) => (
											<div
												className={`grid grid-cols-12 border py-2 laptop-l:py-3  ${
													idx !== links.length - 1
														? 'border-b-transparent border-t-[#C8C8C8] '
														: 'border-y-[#C8C8C8]'
												...
												onPointerEnter={() => {
													...
													if (idx === 0) {
														setPhotoNum(1);
														setSelectedPhoto(
															'/assets/home-pinch-valve.webp'
														);
													}
													if (idx === 1) {
														setPhotoNum(2);
														setSelectedPhoto(
															'/assets/mobile-control.webp'
														);
													}
													if (idx === 2) {
														setPhotoNum(3);
														setSelectedPhoto(
															'/assets/products/spare-sleeves.webp'
														);
													}
													if (idx === 3) {
														setPhotoNum(0);
														setSelectedPhoto(
															'/assets/control-photo.webp'
														);
													}
												}}
												onPointerLeave={() => {
											...
											>
												<div className="col-span-9 flex items-center ">
													<div className="flex flex-col justify-center">
														<h3 className={`pb-2 ${tStyles.cat2} `}>
															{link.title}
														</h3>
														<p
															className={`text-justify opacity-80 laptop:line-clamp-3 laptop-xl:line-clamp-4 ${tStyles.cat3} `}
														>
															{link.description}
														</p>
													</div>
												</div>
												<div className="col-span-1 grid-cols-2"></div>
												<div className="col-span-2 grid-cols-2">
													<Link
														href={link.link}
														className={`flex h-full w-[5vw] items-center justify-center `}
													>
														<Image
															src={Button}
															alt="Button"
