...
{
    public sealed class GetProductsByCategoryDto
    {
        ...
        public ICollection<PinchValvesSleevesDto>? PinchValvesSleeves { get; set; }
        public ICollection<PinchValvesSleevesDto>? Sleeves { get; set; }
