...
namespace CleanArchFramework.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241225160246_Init-OrderUpdate")]
    partial class InitOrderUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanArchFramework.Domain.Entities.Order", b =>
                {
                    ...
                    b.Property<bool>("PackagingCostNeeded")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("ShippingCostNeeded")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("CleanArchFramework.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("CleanArchFramework.Domain.Entities.LocalizationSet", "ConnectionType")
                        .WithMany()
