...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchFramework.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("CustomThings")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("FavePunkPersonality")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PunkHolder")
                        .HasColumnType("text");

                    b.Property<string>("PunkId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CleanArchFramework.Domain.Entities.Podcast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("FeaturedPodcast")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("MessageNextPunk")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PodcastLength")
                        .HasColumnType("text");

                    b.Property<int>("PodcastNo")
                        .HasColumnType("integer");

                    b.Property<Guid?>("PodcastPictureId")
                        .HasColumnType("uuid");

                    b.Property<string>("PrimaryPunk")
                        .HasColumnType("text");

                    b.Property<string>("PunkFewWords")
                        .HasColumnType("text");

                    b.Property<DateTime?>("RecordDate")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("SecondaryPunk")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("CleanArchFramework.Domain.Entities.About", b =>
                {
                    b.HasOne("CleanArchFramework.Domain.Entities.FileStorage", "BackgroundImage")
                        .WithMany()
                        .HasForeignKey("BackgroundImageId");

                    b.HasOne("CleanArchFramework.Domain.Entities.FileStorage", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("CleanArchFramework.Domain.Entities.Podcast", b =>
                {
                    b.HasOne("CleanArchFramework.Domain.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany("Podcast")
                        .HasForeignKey("ApplicationUserId");

                    b.HasOne("CleanArchFramework.Domain.Entities.FileStorage", "PodcastPicture")
                        .WithMany()
                        .HasForeignKey("PodcastPictureId");

                    b.Navigation("ApplicationUser");

                    b.Navigation("PodcastPicture");
                });
