...
namespace CleanArchFramework.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240228100703_Init_Order_orederItem2")]
    partial class Init_Order_orederItem2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanArchFramework.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("CleanArchFramework.Domain.Entities.LocalizationSet", "SutibleFor")
                        .WithMany()
                        .HasForeignKey("SutibleForId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
